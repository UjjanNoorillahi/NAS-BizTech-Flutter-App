...
const String tSignInWithFacebook = "Continue with Facebook";
...
const String tLoginSubTitle = "Please sign in to continue.";
const String tRememberMe = "Remember Me?";
const String tDontHaveAnAccount = "Don't have an Account? ";

// -- Sign Up Screen Text
const String tSignUpTitle = "Create Account!";
const String tSignUpSubTitle = "Fill data to create your account.";
